<a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="/problems/non-overlapping-intervals/">435. Non-overlapping Intervals</a>
